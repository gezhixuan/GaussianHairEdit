...
def loadCam(args, id, cam_info, resolution_scale):
    ...
    if cam_info.alpha is not None:
        resized_alpha = NP_resize(cam_info.alpha, resolution)
        resized_alpha = torch.Tensor(resized_alpha).cuda()
    # =============================================================================================================
    ...
    return Camera(colmap_id=cam_info.uid, R=cam_info.R, T=cam_info.T, 
                  ...
                  image_name=cam_info.image_name, uid=id, data_device=args.data_device, alpha=resized_alpha)
