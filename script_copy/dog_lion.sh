...
data.source=gs_data/dog \
system.gs_source=gs_data/trained_gs_models/dog/point_cloud.ply \
system.guidance.src_prompt="dog" \
system.guidance.tgt_prompt="lion" \
system.prompt_processor.prompt="lion" \
system.guidance.self_attn_th=0.8 \
system.guidance.cross_attn_th=0.3 \
